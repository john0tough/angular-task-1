...
var appRoutes = [
    ...
    { path: 'infouser', component: _user_info_user_info_component__WEBPACK_IMPORTED_MODULE_3__["UserInfoComponent"] },
...
var AppRoutingModule = /** @class */ (function () {
    ...
    AppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forRoot(appRoutes, { enableTracing: true } // <- only for debug popuses
                )
            ],
            exports: [
...
module.exports = "<h1>super client</h1>\n<router-outlet></router-outlet>"
...
/* harmony import */ var _httpClient_usersClient__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./httpClient/usersClient */ "./src/app/httpClient/usersClient.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_httpClient_usersClient__WEBPACK_IMPORTED_MODULE_5__["UsersService"]],
...
/***/ "./src/app/httpClient/usersClient.ts":
/*!*******************************************!*\
  !*** ./src/app/httpClient/usersClient.ts ***!
  \*******************************************/
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.getUsers = function () {
        return this.http.get(this.apiUrl + "search/users", { params: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('q', 'name') });
    };
    UsersService.prototype.getUser = function (login) {
...
module.exports = "<form>\n  <label>Client</label>\n  <br>\n  <input type=\"text\" [(ngModel)]=\"clientName\" name=\"clientName\"/>\n  <br>\n  <button (click)=\"getClients()\">Send</button>\n  <p>{{ clientName }}</p>\n</form>\n <div *ngIf=\"client_count > 0\">\n   <p>Total Users: {{ client_count }}</p>\n   <table>\n     <tr>\n       <td>Users</td>\n     </tr>\n     <tr *ngFor=\"let client of clientList\">\n      <td> {{ client.login }}</td>\n    </tr>\n   </table>\n </div>"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _httpClient_usersClient__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../httpClient/usersClient */ "./src/app/httpClient/usersClient.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsersComponent = /** @class */ (function () {
    ...
    UsersComponent.prototype.getClients = function () {
        var _this = this;
        this.userService.getUsers().subscribe(function (response) { return _this.showUsers(response); });
    };
    UsersComponent.prototype.showUsers = function (users) {
    ...
    UsersComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_httpClient_usersClient__WEBPACK_IMPORTED_MODULE_1__["UsersService"]])
    ], UsersComponent);
...
module.exports = __webpack_require__(/*! E:\Develoment\angulartest\Level1\src\main.ts */"./src/main.ts");
